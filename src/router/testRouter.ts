...
testRouter.post(Paths.Tests.GetAllCustomerTests, TestController.getAllCustomerTests)

testRouter.post(Paths.Tests.GetCustomerTestById, TestController.getCustomerTestById)
