<?php
/**
 * application-form-bypass-READY.php
 *
 * Shared secret MUST match Node API:
 *   PHLEB_APPLICATION_FORM_BYPASS_SECRET  (or PARTNER_SSO_SECRET)
 *
 * App opens:
...
if (!defined('YR_APP_FORM_BYPASS_SECRET')) {
    define('YR_APP_FORM_BYPASS_SECRET', 'Nhchassc56-yTrf56syts-chtwqcscs56cees');
}
